    ...
    <Box>
      ...
      <Typography 
        ...
        <Box sx={{ display: "flex", gap: 1, alignItems: 'center' }}>
          <Typography variant="body2" sx={{ fontWeight: 'bold' }}>Department:</Typography>
      ...
      <Table size="small">
        <TableHead>
          <TableRow>
            <TableCell sx={{ fontSize: '0.9rem', padding: '4px' }}>Question</TableCell>
            <TableCell sx={{ fontSize: '0.9rem', padding: '4px' }}>Response</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {Array.isArray(templateData.questions) && templateData.questions.length > 0 ? (
            templateData.questions.map((question, index) => (
              <TableRow key={index}>
                <TableCell sx={{ fontSize: '0.8rem', padding: '4px' }}>{question.question}</TableCell>
            ...
            <TableRow>
              <TableCell colSpan={2} sx={{ fontSize: '0.8rem', padding: '4px' }}>No questions available</TableCell>
            </TableRow>
          )}
        </TableBody>
      </Table>
